...
import compare from "../images/images/images/compare.svg";
import wishlist from "../images/images/images/wishlist.svg";
import user from "../images/images/images/user.svg";
import cart from "../images/images/images/cart.svg";
import menu from "../images/images/images/menu.svg";
const Header = () => {
  return (
    <>
    <header className='header-top-strip py-3'>
      <div className='container-xxl'>
        <div className='row'>
          <div className='col-6'>
            <p className='text-white mb-0'>Free Shipping Over $100 & Easy Returns</p>
          </div>
          <div className='col-6'>
            <p className='text-end text-white mb-0'>
              Hotline: <a className= 'text-white' href='tel: +91 6350525143'>+91 6350525143</a>
            </p>
          </div>
        </div>
      </div>
    ...
    <header className='header-upper py-3'>
      <div className='container-xxl'>
        <div className='row align-items-center'>
          <div className='col-2'>
            <h2>
              <Link className='text-white'>CraftNext</Link>
            </h2>
          </div>
          <div className='col-5'>
